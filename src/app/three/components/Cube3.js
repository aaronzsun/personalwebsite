...
const Cube = () => {
  ...
  const textures = [
    useLoader(TextureLoader, '/log-side.jpg'),  // Front face
    useLoader(TextureLoader, '/log-side.jpg'),  // Back face
    useLoader(TextureLoader, '/log-top-bottom.jpg'),  // Top face
    useLoader(TextureLoader, '/log-top-bottom.jpg'),  // Bottom face
    useLoader(TextureLoader, '/log-side.jpg'),  // Left face
    useLoader(TextureLoader, '/log-side.jpg'),  // Right face
  ];
  ...
  const materials = textures.map(texture => (
    new THREE.MeshStandardMaterial({
      ...
      emissiveIntensity: 0.2,               // Adjust intensity for subtle glow
